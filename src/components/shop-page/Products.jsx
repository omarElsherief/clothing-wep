...
function Products({ products }) {
    ...
    return (
        <div className="shop-products-grid flex items-start justify-center flex-wrap gap-4">
            {
            products.length?
            products.map((product) => {
                return (
                    <div key={product.id} className=" w-[300px] h-[400px] p-4 border rounded shadow  hover:shadow-lg transition ">
